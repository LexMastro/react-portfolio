...
const Resume = (props) => {
  ...
  const resumeDetails = [
    <div className="resume-screen-container" key="education">
      <ResumeHeading
        heading={"University of Sydney, Australia"}
      ...
      <ResumeHeading
        heading={"Shillington Graphic Design School"}
        subHeading={"CERTIFICATE IV IN GRAPHIC DESIGN"}
        fromDate={"2019"}
        toDate={"2020"}
      />
      <ResumeHeading
        heading={"General Assembly"}
        subHeading={"FRONT-END WEB DEVELOPMENT SHORT-COURSE"}
        fromDate={"2017"}
        toDate={"2018"}
      />
    </div>,
    ...
    <div className="resume-screen-container" key="work-experience">
      <div className="experience-container">
        <ResumeHeading
          heading={"SLOW HOUSE"}
          subHeading={"DIGITAL MANAGER AND GRAPHIC DESIGNER"}
          fromDate={"2021"}
          toDate={"Present"}
        />
        <div className="experience-description">
          <span className="resume-description-text">
            Currently working as digital manager and graphic deisgner for Slow
            House Bondi.
          </span>
        </div>
        <div className="experience-description">
          <span className="resume-description-text">
            Implementation and aintinence of the eccommerce webite.
          </span>
          <br />
          <span className="resume-description-text">
            Managing social media accounts. This includes marketing campaigns
    ...
    <div className="resume-screen-container" key="interests">
      <ResumeHeading
        heading="Yoga"
        description="I am a yoga teacher and have my own online business, where i teach classes via zoom."
      />
      <ResumeHeading
        heading="Animation deisgn"
        description="I enjoy making GIF's and videos in any spare time I have"
      />
      <ResumeHeading
        heading="Reading"
        description="I enjoy reading books....when I have a moment of spare time"
      />
    </div>,
  ];
  ...
  return (
    ...
    >
      <div className="resume-content">
        <ScreenHeading
          title={"Resume"}
          subHeading={"Bio / Skills / Employment / Experience / Interests"}
        />
